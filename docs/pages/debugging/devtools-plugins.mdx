...
安装 dev tools 插件并将所需的连接代码添加到项目后，你可以使用 `npx expo start` 启动开发服务器。然后按 <kbd>Shift</kbd> + <kbd>M</kbd> 打开可用 dev tools 插件列表。选择你想使用的插件，它就会在新的 Chrome 窗口中打开。
...
在终端中运行 `npx expo start`，按 <kbd>Shift</kbd> + <kbd>M</kbd> 打开 dev tools 列表，然后选择 React Navigation 插件。这将打开该插件的 Web 界面，在你浏览应用时显示你的导航历史。
...
在终端中运行 `npx expo start`，按 <kbd>Shift</kbd> + <kbd>M</kbd> 打开 dev tools 列表，然后选择 Apollo Client 插件。这将打开该插件的 Web 界面，在你的应用执行 Apollo Client 操作时显示查询历史、缓存和变更。
...
在终端中运行 `npx expo start`，按 <kbd>Shift</kbd> + <kbd>M</kbd> 打开 dev tools 列表，然后选择 React Query 插件。这将打开该插件的 Web 界面，显示你应用中使用的查询。
...
在终端中运行 `npx expo start`，按 <kbd>Shift</kbd> + <kbd>M</kbd> 打开 dev tools 列表，然后选择 `redux-devtools-expo-dev-plugin`。这将打开该插件的 Web 界面，显示你的 store 的操作和内容，以及操作分发的情况。
...
在终端中运行 `npx expo start`，按 <kbd>Shift</kbd> + <kbd>M</kbd> 打开 dev tools 列表，然后选择 TinyBase 插件。这将打开该插件的 Web 界面，显示你的 store 被修改时的内容。

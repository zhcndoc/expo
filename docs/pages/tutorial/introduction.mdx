...
> **信息** **编程新手？** 你可以通过提示 AI 编程代理来构建这个相同的应用，而不必自己编写代码。请按照 [使用 AI 构建教程](/tutorial/build-with-ai/introduction/) 操作。它会从零开始介绍整个设置过程。
...
> **信息** 本教程的完整源代码可在 [GitHub](https://github.com/expo/examples/tree/master/stickersmash) 上获取。
...
export default function Index() {
  return (
    <View style={styles.container}>
      /* @tutinfo 这以前写的是：“编辑 app/index.tsx 以编辑此屏幕。”。现在写的是：“你好，世界！”。 */<Text>Hello world!</Text>/* @end */
    </View>
  );
}

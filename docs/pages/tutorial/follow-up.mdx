...
要在你的机器上开始创建一个新应用，你可以使用 `npx create-expo-app@latest --template default@sdk-57`，然后按顺序进行[设置你的开发环境](/get-started/set-up-your-environment/)。

> **注意：** 在 SDK 57 过渡期间，不带 `--template` 标志的 `create-expo-app@latest` 会创建一个 SDK 54 项目。如果你计划在实体设备上使用 Expo Go，请使用 SDK 54 项目。否则，请使用 `--template default@sdk-57` 创建 SDK 57 项目。

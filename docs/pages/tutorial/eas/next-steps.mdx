...
<BoxLink
  title="EAS Submit"
  Icon={EasSubmitIcon}
  description="查看 EAS Submit 文档，了解如何通过一条 CLI 命令将应用上传到 Google Play 商店和 Apple App Store。"
...
<BoxLink
  title="eas.json 架构"
  Icon={BookOpen02Icon}
  description="查看完整的架构参考，了解 EAS Build 和 EAS Submit 可用的属性，并学习如何在项目中配置和覆盖它们的默认行为。"
  href="/eas/json/"
/>
...
<BoxLink
  title="应用凭据"
  Icon={BookOpen02Icon}
  description="查看应用凭据指南，了解 Android 和 iOS 的凭据要求。"

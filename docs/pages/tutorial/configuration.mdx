...
<ContentSpotlight
  alt="Android 和 iOS 上均显示浅色样式的 StatusBar。"
...
<ContentSpotlight
  alt="默认应用图标：一个深色圆角方块，内含白色照片图形和黄色笑脸。"
...
<ProgressTracker
  ...
  name="GET_STARTED"
  summary="做得好！我们使用同一套代码库构建了一个可在 Android、iOS 和 Web 上运行的应用。"

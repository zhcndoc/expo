    ...
    <View style={{ top: -350 }}>
      /* @tutinfo 使用 `GestureDetector` 包裹 `Animated.Image` 组件。*/ <GestureDetector gesture={doubleTap}>/* @end */
        <Animated.Image
          source={stickerSource}
          resizeMode="contain"
          style={/* @tutinfo 修改 `Animated.Image` 上的 `style` 属性以传入 `imageStyle`。 */[{ width: imageSize, height: imageSize }, imageStyle]/* @end */}
        />
      /* @tutinfo */
      </GestureDetector>
      /* @end */
...
<ProgressTracker name="GET_STARTED" currentChapterSlug="/tutorial/gestures" />

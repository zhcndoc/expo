...
> **提示** 由于 **ImageViewer** 是一个自定义组件，因此我们将它放在单独的目录中，而不是 **app** 目录中。**app** 目录中的每个文件要么是布局文件，要么是路由文件。更多信息，请参阅 [非导航组件位于 app 目录之外](/router/basics/core-concepts/#6-non-navigation-components-live-outside-the-srcapp-directory)。

...
<ProgressTracker
  ...
  name="GET_STARTED"
  summary="We have successfully implemented the initial design and begun building the first screen of the app."
  nextChapterDescription="In the next chapter, we will add the ability to select images from the device media library."
  nextChapterTitle="Use the Image Picker"

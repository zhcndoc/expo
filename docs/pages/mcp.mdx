---
title: 在 Expo 中使用模型上下文协议（MCP）
sidebar_title: MCP 服务器
description: 一份关于将模型上下文协议集成到 Expo 项目中以增强 AI 模型能力的指南。
hasVideoLink: true
---
...
<VideoBoxLink
  videoId="WLGAuwagI8o"
  time={364}
  title="使用 AI 构建移动应用所需的 3 个工具"
  description="观看 AI 代理在使用 Expo 构建移动应用时使用 MCP 服务器。"
/>
...
安装 MCP 服务器后，你需要进行身份验证。

出现提示时，请在浏览器中使用你的 Expo 账户登录。服务器会自动生成访问令牌。

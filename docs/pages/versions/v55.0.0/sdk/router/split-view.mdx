...
> **info** **注意：** 我们正在积极开发 `SplitView` 并寻求反馈。你可以在 [Discord](https://chat.expo.dev) 上分享你的想法，或在 [GitHub 上提交 issue](https://github.com/expo/expo/issues)，也可以使用本页底部的 **反馈** 按钮。

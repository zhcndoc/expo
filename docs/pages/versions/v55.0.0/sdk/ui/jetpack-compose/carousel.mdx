...
Expo UI 提供了三个轮播组件，与官方 Jetpack Compose [Carousel](https://developer.android.com/develop/ui/compose/components/carousel) API 相匹配：`HorizontalCenteredHeroCarousel`、`HorizontalMultiBrowseCarousel` 和 `HorizontalUncontainedCarousel`。
...
在两个较小的预览项之间居中显示一个大型主视觉项——非常适合展示电影海报等内容。

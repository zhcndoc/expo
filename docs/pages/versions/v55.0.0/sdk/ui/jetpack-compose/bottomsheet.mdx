...
Expo UI ModalBottomSheet 与官方 Jetpack Compose [Bottom Sheet API](https://developer.android.com/develop/ui/compose/components/bottom-sheets) 保持一致，并在一个从底部滑入的模态抽屉中显示内容。
    ...
    <Host matchContents>
      ...
      {visible && (
        <ModalBottomSheet
          ...
          <Column verticalArrangement={{ spacedBy: 12 }} modifiers={[paddingAll(24)]}>
            <Text>这个抽屉不能通过滑动、返回键或点击外部来关闭。</Text>

...
Expo UI Spacer 与官方 Jetpack Compose [Spacer](https://developer.android.com/reference/kotlin/androidx/compose/foundation/layout/package-summary#Spacer) API 对应，用于在布局中添加可伸缩或固定大小的间距。
...
使用 `height` 或 `width` 修饰符创建具有固定尺寸的 spacer。

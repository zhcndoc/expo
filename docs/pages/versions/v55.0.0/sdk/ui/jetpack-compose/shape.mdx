...
Expo UI Shape 与官方 Jetpack Compose [Shapes](https://developer.android.com/develop/ui/compose/graphics/draw/shapes) API 保持一致，并提供了一组用于绘制几何图形的子组件，例如星形、圆形、矩形、胶囊形和多边形。

...
Expo UI Row 与官方 Jetpack Compose [Row](https://developer.android.com/reference/kotlin/androidx/compose/foundation/layout/package-summary#Row) API 保持一致，并以可配置的排列方式和对齐方式将子项水平排列。
...
`Row` 会将子项水平排列。使用 `horizontalArrangement` 和 `verticalAlignment` 来控制间距和对齐方式。

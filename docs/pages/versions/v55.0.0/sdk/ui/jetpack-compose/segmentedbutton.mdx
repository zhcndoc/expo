...
分段按钮允许应用用户从一组并排显示在一行中的少量选项中进行选择。它们对应官方 Jetpack Compose [Segmented Button](https://developer.android.com/develop/ui/compose/components/segmented-button) API。

---
title: 组
description: 一个用于对视图进行分组且不影响布局的 SwiftUI Group 组件。
...
Expo UI Group 与官方 SwiftUI [Group API](https://developer.apple.com/documentation/swiftui/group) 一致，可将多个视图组合在一起，而不会引入额外的布局结构。

---
title: 命名空间
description: 一个 Namespace 组件，允许你在 SwiftUI 中创建命名空间
...
一个 Namespace 组件，允许你创建 SwiftUI [Namespaces](https://developer.apple.com/documentation/swiftui/namespace)，用于协调视图之间的动画和匹配几何效果。
...
Namespaces 用于协调视图之间的动画和匹配几何效果。它们提供一个可跨组件共享的唯一标识符，以创建平滑过渡。

---
title: 覆盖层
description: 一个用于在另一个视图上方叠加内容的 SwiftUI Overlay 组件。
...
Expo UI Overlay 与官方 SwiftUI [overlay](<https://developer.apple.com/documentation/swiftui/view/overlay(alignment:content:)>) 修饰符相匹配，并提供了一种将次级内容层叠在视图之上的方式，使用指定的对齐方式进行定位。

...
`expo-dev-menu` 可以作为任何 Expo 项目中的**独立库**使用。它尤其适用于不需要完整 [`expo-dev-client`](/versions/v55.0.0/sdk/dev-client/) 启动器界面的 [brownfield 应用](/versions/v55.0.0/sdk/brownfield/)。

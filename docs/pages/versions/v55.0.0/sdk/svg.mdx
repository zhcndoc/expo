...
其实现由 [react-native-svg](https://github.com/react-native-community/react-native-svg) 提供，相关文档也在该仓库中提供。
...
- 想找 SVG？试试 [Lucide](https://lucide.dev/)。
- 使用 [Figma](https://www.figma.com/) 可以免费创建或修改你自己的 SVG。
- 使用 [SVGOMG](https://jakearchibald.github.io/svgomg/) 优化你的 SVG。这会让代码更小、更易于使用。请务必不要移除 `viewbox`，这样在 Android 上才能获得最佳效果。

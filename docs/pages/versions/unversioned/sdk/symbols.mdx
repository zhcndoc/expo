...
`expo-symbols` 可跨平台访问原生符号库。在 iOS 和 tvOS 上，它使用 [SF Symbols](https://developer.apple.com/sf-symbols/)。在 Android 和 web 上，它使用 [Material Symbols](https://fonts.google.com/icons)。

<ContentSpotlight
  className="max-w-[200px]"
  src="/static/images/symbols.webp"
  alt="在 iOS 设备上显示的一组 Expo Symbols 符号。"
/>

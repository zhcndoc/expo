...
- 使用 [Figma](https://www.figma.com/) 免费创建或修改你自己的 SVG。
- 使用 [SVGOMG](https://jakearchibald.github.io/svgomg/) 优化你的 SVG。这会让代码更小、更易于处理。请确保不要移除 `viewbox`，这样在 Android 上才能获得最佳效果。

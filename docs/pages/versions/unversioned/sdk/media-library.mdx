...
`expo-media-library` 提供对用户媒体库的访问，允许应用读取已有的图片和视频，以及保存新的图片和视频。

> **warning** 在 Android 上，只有需要广泛访问照片的应用才允许完全访问媒体库（这是该包的主要用途）。请参阅 [Google Play 的照片和视频权限政策详情](https://support.google.com/googleplay/android-developer/answer/14115180)。
...
<Collapsible summary="从网页添加一个新的资源">
<SnackInline label="从网页添加一个新的资源" dependencies={['expo-file-system', 'expo-image', 'expo-media-library']}>
...
<Collapsible summary="创建一个新相册">
<SnackInline label="创建一个新相册" dependencies={["expo-media-library"]}>

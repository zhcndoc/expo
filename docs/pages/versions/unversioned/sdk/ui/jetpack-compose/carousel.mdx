...
Expo UI 提供了三个 Carousel 组件，与官方的 Jetpack Compose [Carousel](https://developer.android.com/develop/ui/compose/components/carousel) API 保持一致：`HorizontalCenteredHeroCarousel`、`HorizontalMultiBrowseCarousel` 和 `HorizontalUncontainedCarousel`。
...
<ContentSpotlight
  ...
  alt="带有一个主视觉项和较小预览项的 Material 3 多项浏览轮播"
/>

...
Expo UI provides three carousel components, aligned with the official Jetpack Compose [Carousel](https://developer.android.com/develop/ui/compose/components/carousel) API: `HorizontalCenteredHeroCarousel`, `HorizontalMultiBrowseCarousel`, and `HorizontalUncontainedCarousel`.
...
<ComponentDiagram
  ...
  alt="带有主视觉项和较小预览项的 Material 3 多浏览轮播"
/>

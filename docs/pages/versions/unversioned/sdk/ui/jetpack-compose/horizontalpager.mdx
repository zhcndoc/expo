---
title: 横向分页器
description: 一个可滑动页面的 Jetpack Compose 横向分页器组件。
...
`HorizontalPager` 不会强制设置自身的高度——请使用 [`height`](modifiers/#heightvalue) 修饰符为其设置高度，或将其放置在具有有限高度的父组件中。
...
<ContentSpotlight
  ...
  alt="显示三个页面中的第二个页面的 HorizontalPager，下方有页面指示器"
/>

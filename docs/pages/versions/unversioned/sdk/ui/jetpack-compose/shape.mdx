---
title: 形状
description: 用于绘制几何形状的 Jetpack Compose Shape 组件。
...
Expo UI Shape 与官方 Jetpack Compose [Shapes](https://developer.android.com/develop/ui/compose/graphics/draw/shapes) API 保持一致，并提供了一组子组件，用于绘制星形、圆形、矩形、药丸形和多边形等几何图形。

<ComponentDiagram
  mode="landscape"
  source="/static/images/expo-ui/shape/android-light.webp"
  darkSource="/static/images/expo-ui/shape/android-dark.webp"
  alt="四种几何图形：六边形、圆形、圆角矩形和药丸形"
/>

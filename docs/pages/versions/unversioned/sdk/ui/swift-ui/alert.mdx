...
Expo UI `Alert` 与官方 SwiftUI [警告 API](<https://developer.apple.com/documentation/swiftui/view/alert(_:ispresented:actions:message:)>) 一致，并会显示一个原生 iOS 警告对话框，其中包含标题、操作按钮以及可选消息。

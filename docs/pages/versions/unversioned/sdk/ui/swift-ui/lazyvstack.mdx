...
> **信息** `LazyVStack` 目前还不是真正的惰性加载：原生端只会构建可见项，但 React 仍会提前创建所有子项，因此大型列表在挂载时可能会很慢。我们正在努力改进这一点。对于大型列表，我们推荐使用 [FlashList](https://shopify.github.io/flash-list/) 或 [Legend List](https://github.com/LegendApp/legend-list)。

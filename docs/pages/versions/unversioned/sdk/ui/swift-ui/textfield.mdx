...
> **注意:** Worklets 需要安装 [`react-native-worklets`](https://docs.swmansion.com/react-native-worklets/). `selection` 属性需要 iOS 18.0+ / tvOS 18.0+。在较旧版本上，worklet 仍然可以更新文本，但无法进行光标定位。

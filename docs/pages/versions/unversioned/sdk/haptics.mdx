...
> **信息** 对于更高级的触觉控制，我们推荐使用 [Pulsar haptics SDK](https://docs.swmansion.com/pulsar/)。它可以让你创建自定义触觉模式、使用更多预设、构建基于手势的触觉效果，并在 worklets 上运行触觉效果。
...
<SnackInline label='触觉使用' dependencies={['expo-haptics']}>

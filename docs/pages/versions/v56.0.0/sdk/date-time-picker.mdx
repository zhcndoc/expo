...
> **重要** [`@expo/ui` provides a drop-in replacement](./ui/drop-in-replacements/datetimepicker) for `@react-native-community/datetimepicker`, powered by Jetpack Compose on Android and SwiftUI on iOS.

一个组件，用于访问系统 UI 以选择日期和时间。

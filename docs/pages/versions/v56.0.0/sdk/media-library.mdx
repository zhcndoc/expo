...
`expo-media-library` 提供对用户媒体库的访问，允许应用读取已有的图片和视频，也可以保存新的内容。

> **warning** 在 Android 上，只有需要对照片进行广泛访问的应用才允许完全访问媒体库（这是此包的主要用途）。请参阅 [Google Play 的照片和视频权限政策详情](https://support.google.com/googleplay/android-developer/answer/14115180)。
...
<Collapsible summary="从网络添加一个新的资源">
<SnackInline label="从网络添加一个新的资源" dependencies={['expo-file-system', 'expo-image', 'expo-media-library']}>

...
`expo-media-library` 提供对用户媒体库的访问，使应用能够读取现有图片和视频，以及保存新的内容。

> **warning** 在 Android 上，只有需要对照片进行广泛访问的应用才允许完全访问媒体库（这是此包的主要用途）。请参阅 [Google Play 照片和视频权限政策的详细信息](https://support.google.com/googleplay/android-developer/answer/14115180)。
...
<Collapsible summary="从网络添加新的资源">
<SnackInline label="从网络添加新的资源" dependencies={['expo-file-system', 'expo-image', 'expo-media-library']}>

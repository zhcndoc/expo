---
title: 开关
description: 用于切换控制的 Jetpack Compose 开关组件。
...
Expo UI Switch 与官方 Jetpack Compose [Switch](https://developer.android.com/develop/ui/compose/components/switch) API 一致。

<ComponentDiagram
  mode="landscape"
  source="/static/images/expo-ui/switch/android-light.webp"
  darkSource="/static/images/expo-ui/switch/android-dark.webp"
  alt="两个展示开启和关闭状态的 Material 3 开关"
/>
...
使用 `Switch.ThumbContent` 在拇指内部渲染自定义元素。`Switch.DefaultIconSize` 会提供 M3 默认图标大小，使你的内容恰好适配。

...
Expo UI AlertDialog 与官方 Jetpack Compose [AlertDialog](https://developer.android.com/develop/ui/compose/components/dialog) API 相匹配。内容通过槽位子组件（`AlertDialog.Title`、`AlertDialog.Text`、`AlertDialog.ConfirmButton`、`AlertDialog.DismissButton`、`AlertDialog.Icon`）提供，这些子组件可直接映射到 Compose 的槽位参数。
...
<ContentSpotlight
  ...
  alt="带有标题、辅助文本以及取消/放弃按钮的 Material 3 警告对话框"
/>

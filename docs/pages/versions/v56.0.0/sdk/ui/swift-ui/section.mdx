...
Expo UI 的 Section 与官方 SwiftUI [Section API](https://developer.apple.com/documentation/swiftui/section) 保持一致，用于在 [`List`](list)、[`Form`](form) 或 [`Picker`](picker) 组件中对相关内容进行分组。
...
<ContentSpotlight
  ...
  alt="Form 中的两个 Section，每个都有一个页眉和分组的 Toggle"
/>

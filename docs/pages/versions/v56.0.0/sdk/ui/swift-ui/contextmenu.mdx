...
Expo UI ContextMenu 匹配官方 SwiftUI [contextMenu API](<https://developer.apple.com/documentation/swiftui/view/contextmenu(menuitems:)>)，并在长按时显示菜单。对于单击菜单交互，请改用 [`Menu`](menu)。
...
<ContentSpotlight
  ...
  alt="长按的磁贴以放大的预览形式显示，其下方带有“分享”“收藏”“删除”菜单"
/>

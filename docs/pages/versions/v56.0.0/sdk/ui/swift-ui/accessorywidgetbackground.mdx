...
description: 一个 SwiftUI 自适应背景视图，会根据小组件的环境提供标准外观。
...
Expo UI AccessoryWidgetBackground 与官方 SwiftUI [AccessoryWidgetBackground API](https://developer.apple.com/documentation/widgetkit/accessorywidgetbackground) 保持一致，并创建一个自适应背景视图，根据小组件的环境提供标准外观。

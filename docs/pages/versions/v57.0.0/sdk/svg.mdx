...
该实现由 [react-native-svg](https://github.com/react-native-community/react-native-svg) 提供，相关文档也托管在该仓库中。
...
- 使用 [SVGOMG](https://jakearchibald.github.io/svgomg/) 优化你的 SVG。这会让代码更小，也更容易处理。请务必不要移除 `viewbox`，这样在 Android 上才能获得最佳效果。

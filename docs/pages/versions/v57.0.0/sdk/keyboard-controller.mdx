...
description: 一个提供键盘管理器的库，在 Android 和 iOS 上以完全相同的方式工作
...
`react-native-keyboard-controller` 提供了超出 React Native 内置键盘 API 的额外功能，只需极少的配置即可在 Android 和 iOS 上保持一致性，并带来用户所期望的原生体验。
...
<BoxLink
  title="高级键盘处理"
  description="了解有关使用 Keyboard Controller 的高级键盘处理示例的更多信息。"
  Icon={BookOpen02Icon}

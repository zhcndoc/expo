---
title: 命名空间
description: 一个 Namespace 组件，可让你在 SwiftUI 中创建命名空间
...
一个命名空间组件，允许你创建 SwiftUI [命名空间](https://developer.apple.com/documentation/swiftui/namespace)，用于协调视图之间的动画和匹配几何效果。

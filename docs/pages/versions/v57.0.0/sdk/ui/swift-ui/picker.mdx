...
> **info** 如需跨平台使用，请查看通用的 [`Picker`](../universal/picker) —— 它会根据平台渲染相应的原生组件。

Expo UI Picker 与官方 SwiftUI [Picker API](https://developer.apple.com/documentation/swiftui/picker) 保持一致，并通过 [`pickerStyle`](modifiers/#pickerstylestyle) 修饰器支持所有 picker 样式。
...
<ContentSpotlight
  ...
  alt="菜单样式的 Picker，显示水果选项，当前选中的项已勾选"
/>

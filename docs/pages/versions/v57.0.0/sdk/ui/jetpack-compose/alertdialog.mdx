...
Expo UI AlertDialog 与官方 Jetpack Compose [AlertDialog](https://developer.android.com/develop/ui/compose/components/dialog) API 保持一致。内容通过插槽式子组件（`AlertDialog.Title`、`AlertDialog.Text`、`AlertDialog.ConfirmButton`、`AlertDialog.DismissButton`、`AlertDialog.Icon`）提供，并直接映射到 Compose 的插槽参数。
...
<ContentSpotlight
  ...
  alt="带有标题、辅助文本以及取消/放弃按钮的 Material 3 警报对话框"
/>

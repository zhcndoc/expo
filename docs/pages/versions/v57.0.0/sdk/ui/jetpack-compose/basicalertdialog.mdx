...
Expo UI BasicAlertDialog 与官方 Jetpack Compose [BasicAlertDialog](https://developer.android.com/develop/ui/compose/components/dialog) API 保持一致，并显示一个最简对话框，允许将自定义子组件作为其内容，从而让你完全控制对话框布局。
...
<ContentSpotlight
  ...
  alt="带有自定义内容的 Material 3 基本警报对话框"
/>

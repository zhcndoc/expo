...
`expo-media-library` 提供对用户媒体库的访问权限，使应用能够读取现有图片和视频，以及保存新的内容。

> **warning** 在 Android 上，对媒体库的完整访问权限（此包的主要用途）仅允许需要广泛访问照片的应用。请参阅 [Google Play 的照片和视频权限政策详情](https://support.google.com/googleplay/android-developer/answer/14115180)。

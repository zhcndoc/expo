...
使用 `npx create-expo-app` 创建的每个新的 Expo 项目都会自动配置 Babel，并使用 [`babel-preset-expo`](https://github.com/expo/expo/tree/main/packages/babel-preset-expo) 作为默认预设。除非你需要自定义 Babel 配置，否则无需创建 **babel.config.js** 文件。

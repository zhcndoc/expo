...
Expo 主要是为全新项目构建的，但我们正在越来越多地投入到棕地场景中。并非所有 Expo 工具和服务目前都与现有原生项目兼容。此外，针对棕地集成的完整文档可能尚未提供，你可能需要根据你的上下文调整其他相关文档。

| 工具/服务                                                                                         | 支持棕地？ |
| ---------------------------------------------------------------------------------------------------- | -------------------- |
| [Expo SDK](/versions/latest/) - React Native 的扩展标准库                        | <YesIcon />          |
| [Expo Modules API](/modules/overview/) - 使用符合惯用方式的 Swift/Kotlin API 构建原生扩展 | <YesIcon />          |
| [Expo Router](/router/introduction/) - 基于文件的路由和导航                             | <YesIcon />          |
| [Expo CLI](/more/expo-cli/) - 用于从终端运行和开发应用的工具                   | <YesIcon />          |
| [Expo Dev Client](/versions/latest/sdk/dev-client/) - 为 Debug 构建版本添加应用内开发者工具  | <NoIcon />           |
| [EAS Build](/build/introduction/) - 专为 Expo/React Native 构建的 CI/CD 服务         | <YesIcon />          |
| [EAS Submit](/deploy/submit-to-app-stores/) - 将应用上传到应用商店的托管服务       | <YesIcon />          |
| [EAS Update](/eas-update/introduction/) - 即时更新应用的 JavaScript 和资源          | <YesIcon />          |
...
如果你使用 AI 代理，请安装 [Expo Skills](/skills/)，以教会它两种棕地集成方法：

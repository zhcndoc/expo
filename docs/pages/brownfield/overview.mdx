...
| [Expo Modules API](/modules/overview/) - 使用符合惯用风格的 Swift/Kotlin API 构建原生扩展 | <YesIcon />          |
| [Expo Router](/router/introduction/) - 基于文件的路由和导航                             | <YesIcon />          |
| [Expo CLI](/more/expo-cli/) - 用于从终端运行和开发应用的工具                   | <YesIcon />          |
| [Expo Dev Client](/versions/latest/sdk/dev-client/) - 为 Debug 构建添加应用内开发者工具  | <NoIcon />           |
| [EAS Build](/build/introduction/) - 专为 Expo/React Native 构建的 CI/CD 服务         | <YesIcon />          |
| [EAS Submit](/submit/introduction/) - 将应用上传到应用商店的托管服务               | <YesIcon />          |
| [EAS Update](/eas-update/introduction/) - 应用 JavaScript 和资源文件的即时更新          | <YesIcon />          |

...
<Step label="3">
将以下行添加到你应用的 **build.gradle** 文件中（通常是 **app/build.gradle** — 你可以参考 [bare minimum 模板文件](https://github.com/expo/expo/blob/main/templates/expo-template-bare-minimum/android/app/build.gradle)）：

...
- <PlatformTag platform="ios" /> [CocoaPods](https://cocoapods.org/): iOS 可用的依赖管理系统之一。CocoaPods 是一个 Ruby [gem](https://en.wikipedia.org/wiki/RubyGems)。你可以使用最新版 macOS 自带的 Ruby 来安装 CocoaPods。

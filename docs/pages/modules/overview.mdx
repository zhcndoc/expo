...
如果你使用 AI agent，请安装 [Expo Skills](/skills/)，以教会它模块定义 DSL 和原生视图模式：
...
在大多数情况下，Expo 和 React Native 开发者并不需要编写任何原生代码——从相机、视频、地图到触觉反馈等各种用例，现成的库已经可用，而且还有更多。
...
<BoxLink
  ...
  description="使用 Kotlin 和 Swfit 创建原生模块的参考文档。"
  href="/modules/module-api/"
  Icon={CpuChip01Icon}
/>

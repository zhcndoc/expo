...
> **warning** 本教程适用于 macOS 用户，因为 `expo-type-information` 包仅能在 macOS 上运行。
...
<Terminal
  cmd={['$ npx expo-type-information module-interface --module ./expo-settings']}
...
<Terminal
  cmd={['$ npx expo-type-information module-interface --module ./expo-settings -w']}

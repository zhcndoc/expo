...
有关设置这两种选项的分步说明，请参阅[使用 TestFlight 分发 iOS 应用](/submit/testflight/)。

</Collapsible>

<BoxLink
  title="EAS 提交"
  description="了解如何将应用上传到应用商店测试轨道和发布轨道。"
...
一旦创建了内部分发构建，它就可以立即下载和安装——无需填写任何表单，也无需等待审批/处理。你可以使用内部分发来共享发布构建和开发构建。

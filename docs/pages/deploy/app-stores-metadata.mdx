...
> **重要** **EAS 元数据** 处于 [beta](/more/release-statuses/#beta) 阶段，且可能发生破坏性变更。该服务目前 **仅支持 Apple App Store**。
...
> **信息** **提示：** 使用 VS Code？安装 [Expo Tools 扩展](https://github.com/expo/vscode-expo#readme)，以便在你的 **store.config.json** 文件中获得自动补全、建议和警告。

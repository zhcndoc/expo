...
**EAS Submit** 是一项托管服务，允许使用 EAS CLI 将应用二进制文件上传并提交到应用商店。本指南介绍如何使用 EAS Submit 将你的应用提交到 Google Play Store 和 Apple App Store。
...
<Prerequisites>
  <Requirement title="注册 Apple Developer 账户">
    提交你的应用到 Apple App Store 需要一个 Apple Developer 账户。你可以在 [Apple 开发者门户](https://developer.apple.com/account/) 注册 Apple Developer 账户。
  </Requirement>

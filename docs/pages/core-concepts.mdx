...
| 使用 [Snack](https://snack.expo.dev/) 在浏览器中创建并分享示例应用。                | <YesIcon /> | <NoIcon />                         |
| 无需原生改动即可进行重大升级。                                                       | <YesIcon /> | <NoIcon />                         |
| 一流的 TypeScript 支持。                                                             | <YesIcon /> | <NoIcon />                         |
| 从命令行安装原生兼容的库。                                                            | <YesIcon /> | <NoIcon />                         |
| 使用同一套代码库开发高性能网站。                                                       | <YesIcon /> | <NoIcon />                         |
| 将你的开发服务器通过 [Tunnel](/more/expo-cli/#tunneling) 转发到任意设备。           | <YesIcon /> | <NoIcon />                         |

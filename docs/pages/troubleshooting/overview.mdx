...
<BoxLink
  ...
  description="了解如何安装与你的项目 Expo SDK 版本兼容的 Expo Go 版本。"
...
<BoxLink
  ...
  description="了解 React Native 版本不匹配的含义，以及如何在 Expo 或 React Native 应用中解决此问题。"
...
<BoxLink
  title="EAS Observe：故障排查"
  description="设置和使用 EAS Observe 时常见问题的解决方案。"
  href="/eas/observe/reference/troubleshooting/"
  Icon={ActivityIcon}
/>

<BoxLink
  title="EAS Workflows：故障排查"
  description="诊断并修复运行 EAS Workflows 时的常见问题。"

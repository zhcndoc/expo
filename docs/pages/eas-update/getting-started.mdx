...
<BoxLink
  ...
  description="Learn how to quickly iterate by sharing updates for QA and testing."
...
<BoxLink
  ...
  description="Learn about the different deployment modes available for your project when using EAS Update."

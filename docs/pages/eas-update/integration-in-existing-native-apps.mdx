...
> **info** 如果你的项目是一个 **greenfield React Native 应用**——从一开始主要使用 React Native 构建，并且应用的入口点就是 React Native，那么请跳过本指南，直接继续阅读 [Get started with EAS Update](/eas-update/getting-started/)。

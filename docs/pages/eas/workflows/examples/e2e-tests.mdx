...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <ContentSpotlight
    alt="默认 Expo 模板应用在 iOS 模拟器上的首页，包含一个 “欢迎！” 标题和入门步骤。"
    src="/static/images/eas-build/tests/01-home.png"
    className="max-w-[360px]"
  />
  <ContentSpotlight
    alt="默认 Expo 模板应用在 iOS 模拟器上的探索页，列出了诸如基于文件的路由和自定义字体等可折叠分区。"
...
<ContentSpotlight
  alt="EAS 仪表板显示一个已完成的端到端测试工作流运行，其中 iOS 构建和 Maestro 测试任务均已完成。"

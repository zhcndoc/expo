...
通过确认它在项目设置中的 [环境变量](https://expo.dev/accounts/[account]/projects/[project]/environment-variables) 中显示 **production** 徽标，来验证环境变量是否已成功创建。环境变量也可以直接在 [expo.dev](https://expo.dev) 上管理。

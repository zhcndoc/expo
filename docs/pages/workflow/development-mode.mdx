...
> **info** 在生产模式下，控制台日志不会显示在 Expo CLI 终端中。要通过设备上的原生日志访问这些日志，请参阅 [查看生产模式下的控制台日志](/workflow/logging/#view-console-logs-in-production-mode)。

要完整地为生产环境编译你的应用，请参阅 [编译 Android](/more/expo-cli/#compiling-android) 和 [编译 iOS](/more/expo-cli/#compiling-ios)。

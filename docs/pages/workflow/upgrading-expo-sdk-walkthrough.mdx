...
如果你正在寻找安装特定版本的 Expo Go，请访问 [expo.dev/go](https://expo.dev/go) 或使用 [`expo-go` CLI](/develop/tools/#expo-go-cli)。它支持为 Android 设备/模拟器和 iOS 模拟器下载。不过，由于 iOS 平台限制，只有最新版本的 Expo Go 可安装到物理 iOS 设备上。

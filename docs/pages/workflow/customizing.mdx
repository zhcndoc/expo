...
如果你正在使用 [Expo Go](https://expo.dev/go)，[你只能访问 Expo SDK 中包含的原生库](/versions/latest/sdk/third-party-overview/)，或不包含任何自定义原生代码的库（[了解更多](/workflow/using-libraries/#third-party-libraries)）。[创建开发构建](/develop/development-builds/introduction/)后，你就可以像在其他任何原生应用中一样修改原生代码或配置。

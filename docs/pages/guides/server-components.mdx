...
Library authors can use `jest-expo` to test whether their modules support Server Components. For more information, please refer to the [Testing React Server Components](/guides/testing-rsc) guide.

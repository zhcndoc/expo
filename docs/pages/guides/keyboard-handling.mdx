...
<Prerequisites>
  <Requirement title="开发构建">
    Keyboard Controller 库不包含在 Expo Go 中。有关更多信息，请参阅[创建开发构建](/develop/development-builds/introduction/#how-would-you-like-to-build-your-development-build)。
  </Requirement>
  <Requirement
    title={
      <>
        已安装 <CODE>react-native-reanimated</CODE>
      </>
    }>
    Keyboard Controller 需要 `react-native-reanimated` 才能正常工作。请按照
    [安装说明](/versions/latest/sdk/reanimated/#installation) 进行操作。
  </Requirement>
</Prerequisites>

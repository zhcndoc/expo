...
你可以通过创建一个 **PrivacyInfo.xcprivacy** 文件并使用 Xcode 将其添加到 iOS 应用目标中，来在[现有的 React Native 项目](/bare/overview/)中包含 iOS 隐私清单。
请按照 [Apple 的隐私清单文件](https://developer.apple.com/documentation/bundleresources/privacy_manifest_files) 指南创建 **PrivacyInfo.xcprivacy** 文件。

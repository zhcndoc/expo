...
与 Apple App Store 不同，在 Apple App Store 中应用图标始终会自动从应用包中获取；而在 Google Play 商店中，您还必须为商店列表单独上传一个应用图标。
...
| 功能图片   | 1    | 1024 × 500                                                       | JPEG 或 24 位 PNG（不带 Alpha）           |
| 屏幕截图   | 4-10 | 最小：1024 × 500<br/>最大宽度：3840px<br/>宽高比：9:16 | JPEG 或 24 位 PNG（不带 Alpha）           |

### App Store - iPhone

| 类型                                     | 数量 | 尺寸（任选其一）       | 要求                |
| ---------------------------------------- | ---- | ---------------------- | ------------------- |
| 屏幕截图（配备灵动岛的 iPhone）         | 2-10 | 1320 × 2868<br/>1290 × 2796 | JPG 或 PNG（不带 Alpha） |

### App Store - iPad

如果您的应用也能在 iPad 上运行，则需要提供额外的屏幕截图。

| 类型       | 数量 | 尺寸（任选其一）       | 要求                |
| ---------- | ---- | ---------------------- | ------------------- |
| 屏幕截图   | 2-10 | 2064 × 2752<br/>2048 × 2732 | JPG 或 PNG（不带 Alpha） |

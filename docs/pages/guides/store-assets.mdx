...
<ContentSpotlight
  alt="Expo Go 在 Apple App Store 列表页面的截图"
  caption="Expo Go 在 Apple App Store 列表页面的截图。"
...
<ContentSpotlight
  alt="Brex 在 Apple App Store 列表页面的截图"
  caption="Brex 在 Apple App Store 列表页面的截图。"
...
<ContentSpotlight
  alt="MS Office 在 Apple Store 列表页面的截图"
  caption="MS Office 在 Apple Store 列表页面的截图。"
...
| 类型                                         | 数量 | 尺寸（选择其一）        | 要求                |
| -------------------------------------------- | ---- | ----------------------- | ------------------- |
| 截图（带灵动岛的 iPhone）                    | 2-10 | 1320 × 2868<br/>1290 × 2796 | JPG 或 PNG（不带 alpha） |

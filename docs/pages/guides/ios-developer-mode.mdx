...
运行 iOS 16 及以上版本的设备需要先启用系统级的 **开发者模式** 设置，然后才能在设备上安装并运行 [内部发布](/build/internal-distribution) 构建（包括使用 EAS 构建的内容）或本地开发构建。
...
在 **设备** 下，你会看到一条警告：“先前的准备错误：开发者模式已停用”，并附有在 iOS 设备上启用开发者模式的说明。

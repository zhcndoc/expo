...
<Prerequisites>
  <Requirement title="使用 Metro 进行 Web 构建的项目">
...
如果你使用 AI 代理，请安装 [Expo Skills](/skills/)，以教会它进行通用的 Tailwind CSS 设置：

<RelatedSkills names={['expo-tailwind-setup']} />

## Android 和 iOS 的替代方案

或者，你可以使用 [DOM 组件](/guides/dom-components) 在原生环境中的 `WebView` 里渲染你的 Tailwind Web 代码。

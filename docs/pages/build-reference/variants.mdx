...
要在设备上安装应用的多个变体，每个变体都必须具有唯一的 [Application ID（Android）](/versions/latest/config/app/#package) 或 [Bundle Identifier（iOS）](/versions/latest/config/app/#bundleidentifier)。

...
<Collapsible summary="Rounded corners example">
...
<ContentSpotlight
  ...
  alt="A web modal with rounded corners."
/>
...
For your web app, if the project uses a [global CSS](https://docs.expo.dev/versions/latest/config/metro/#global-css) file, you can also override the width, height, border, and overlay variables.

You can add custom values in a global CSS file using `--expo-router-*` variables:

```css
/* Globally override the default modal styles */
:root {

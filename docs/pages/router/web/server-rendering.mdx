...
| 动态路由           |     | 需要 [`generateStaticParams`](/router/web/static-rendering/#generatestaticparams)    | 自动生效                   |
| 元数据             |     | [`<Head>`](/versions/latest/sdk/router/#head) 组件                                  | [`generateMetadata`](#metadata) |

...
- 对于原生应用，使用 API 路由进行安全的数据获取。当原生应用调用 API 路由时，这些请求会先经过 middleware。
...
- [适用于 API 路由的相同限制](/router/web/api-routes/#known-limitations)也适用于 middleware。

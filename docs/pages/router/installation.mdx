...
如果你已经有一个现有项目，并且想添加 Expo Router，请按照以下步骤操作。对于新项目，请参阅介绍指南中的 [快速开始](/router/introduction/#quick-start)。

<Prerequisites>
  <Requirement title="设置你的开发环境">
    确保你的电脑已[配置好用于运行 Expo 应用](/get-started/create-a-project/)。
  </Requirement>
</Prerequisites>
...
1. 在项目根目录下创建一个新文件，例如 **index.js**。创建此文件后，项目结构应如下所示：
   ...
   <FileTree files={['src/app/_layout.tsx', 'index.js', 'package.json', '其他项目文件']} />

...
要控制 `NavigationBar` 的可见性，你可以使用 [`hidden`](/versions/latest/sdk/navigation-bar/#hidden) 属性或 [`NavigationBar.setHidden`](/versions/latest/sdk/navigation-bar/#sethiddenhidden) 方法。

...
使用配置插件嵌入资源后，[创建新的开发构建](/develop/development-builds/introduction/#how-would-you-like-to-build-your-development-build)。现在，你可以在项目中导入并使用该资源，而无需使用 `require` 或 `import` 语句。

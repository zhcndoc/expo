...
| ------------------- | --------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `to`                | Android and iOS | `string \| string[]`                                      | Expo 推送令牌，或用于指定此消息接收者的 Expo 推送令牌数组。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `_contentAvailable` | iOS Only        | `boolean \| undefined`                                    | 当设置为 true 时，通知会使 iOS 应用在后台启动以运行一个 [后台任务](/versions/latest/sdk/notifications/#background-notifications)。你的应用需要经过 [配置](/versions/latest/sdk/notifications/#background-notification-configuration) 才能支持此功能。                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `data`              | Android and iOS | `Object`                                                  | 传递给应用的 JSON 对象。其大小最多约为 4KiB；发送到 Apple 和 Google 的通知总负载必须最多为 4KiB，否则你会收到 “Message Too Big” 错误。                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `title`             | Android and iOS | `string`                                                  | 显示在通知中的标题。通常显示在通知正文上方。对应 [`AndroidNotification.title`](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#AndroidNotification) 和 [`aps.alert.title`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Payload-key-reference)。                                                                                                                                                                                                                                                                                                   |
| `body`              | Android and iOS | `string`                                                  | 显示在通知中的消息。对应 [`AndroidNotification.body`](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#AndroidNotification) 和 [`aps.alert.body`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Payload-key-reference)。                                                                                                                                                                                                                                                                                                                                                |
| `ttl`               | Android and iOS | `number`                                                  | 生存时间：如果消息尚未投递，可保留用于重新投递的秒数。默认为 `undefined`，以使用各个提供方的默认值（Android/FCM 和 iOS/APNs 均为 1 个月）。                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `expiration`        | Android and iOS | `number`                                                  | 自 Unix 纪元以来的时间戳，指定消息何时过期。效果与 `ttl` 相同（`ttl` 优先于 `expiration`）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `priority`          | Android and iOS | `'default' \| 'normal' \| 'high'`                         | 消息的投递优先级。指定 `default` 或省略此字段以使用各平台的默认优先级（Android 上为 “normal”，iOS 上为 “high”）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `subtitle`          | iOS Only        | `string`                                                  | 显示在通知中、标题下方的副标题。对应 [`aps.alert.subtitle`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Payload-key-reference)。                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `sound`             | iOS Only        | `string \| null`                                          | 当接收者收到此通知时播放声音。指定 `default` 以播放设备的默认通知声音，或省略此字段以不播放声音。自定义声音需要通过 config plugin 进行 [配置](/versions/latest/sdk/notifications/#configurable-properties)，然后在指定时包含文件扩展名。例如：`bells_sound.wav`。                                                                                                                                                                                                                                                                                                 |
| `badge`             | iOS Only        | `number`                                                  | 显示在应用图标角标上的数字。指定零可清除角标。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `interruptionLevel` | iOS Only        | `'active' \| 'critical' \| 'passive' \| 'time-sensitive'` | 通知的重要性和投递时机。这些字符串值对应 [`UNNotificationInterruptionLevel`](https://developer.apple.com/documentation/usernotifications/unnotificationinterruptionlevel) 枚举的各个 case。                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `channelId`         | Android Only    | `string`                                                  | 用于显示此通知的通知渠道 ID。如果指定了 ID，但设备上不存在对应渠道（尚未由你的应用创建），则通知不会显示给用户。                                                                                                                                                                                                                                                                                                                                                                                                              |
| `icon`              | Android Only    | `string`                                                  | 通知图标。Android drawable 资源名称（例如：`myicon`）。默认使用在 [config plugin](/versions/latest/sdk/notifications/#configurable-properties) 中指定的图标。                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `richContent`       | Android and iOS | `Object`                                                  | 目前支持设置通知图片。提供一个包含键 `image`、值类型为 `string` 的对象，其中该字符串为图片 URL。Android 会开箱即用地显示图片。在 iOS 上，你需要向应用添加一个 Notification Service Extension target。有关如何操作，请参见 [这个示例](https://github.com/expo/expo/pull/36202)。                                                                                                                                                                                                                                                                                                                           |
| `categoryId`        | Android and iOS | `string`                                                  | 此通知所关联的通知类别 ID。[在这里了解更多关于通知类别的信息](/versions/latest/sdk/notifications/#manage-notification-categories-interactive-notifications)。                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `collapseId`        | Android and iOS | `string`                                                  | 用于折叠通知的标识符。在 Android 上，这只会合并传输中的消息（如果设备离线，则只会投递具有给定 `collapseId` 的最新一条），并映射到 FCM 的 [`collapse_key`](https://firebase.google.com/docs/cloud-messaging/customize-messages/collapsible-message-types)。若要同时替换 Android 上已显示的通知，请使用 `tag`。在 iOS 上，这既会合并传输中的消息，也会替换设备上已显示的通知，并映射到 [`apns-collapse-id`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Send-a-POST-request-to-APNs)。 |
| `tag`               | Android Only    | `string`                                                  | 用于替换设备上已显示通知的标识符。如果设备上已经显示了具有相同 `tag` 的通知，则新的通知会替换它。这与 `collapseId` 不同，后者合并的是 _传输中_ 的消息，而 `tag` 替换的是 _已显示_ 的通知。对应 FCM 的 [`notification.tag`](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#AndroidNotification) 字段。                                                                                                                                                                                                            |

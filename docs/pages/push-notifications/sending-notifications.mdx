...
| 字段                | 平台            | 类型                                                      | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------- | --------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `to`                | Android 和 iOS  | `string \| string[]`                                      | 指定此消息接收者的 Expo 推送令牌或 Expo 推送令牌数组。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `_contentAvailable` | 仅限 iOS        | `boolean \| undefined`                                    | 设置为 true 时，通知将导致 iOS 应用在后台启动以运行[后台任务](/versions/latest/sdk/notifications/#headless-background-notifications)。你的应用需要进行[配置](/versions/latest/sdk/notifications/#background-notification-configuration)才能支持此功能。                                                                                                                                                                                                                                                                                                                                             |
| `data`              | Android 和 iOS  | `Object`                                                  | 传递给应用的 JSON 对象。其大小最多约为 4KiB；发送到 Apple 和 Google 的通知负载总大小必须不超过 4KiB，否则会收到“消息过大”错误。                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `title`             | Android 和 iOS  | `string`                                                  | 要在通知中显示的标题。通常显示在通知正文上方。映射到 [`AndroidNotification.title`](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#AndroidNotification) 和 [`aps.alert.title`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Payload-key-reference)。                                                                                                                                                                                                                                                                                                   |
| `body`              | Android 和 iOS  | `string`                                                  | 要在通知中显示的消息。映射到 [`AndroidNotification.body`](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#AndroidNotification) 和 [`aps.alert.body`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Payload-key-reference)。                                                                                                                                                                                                                                                                                                                                                |
| `ttl`               | Android 和 iOS  | `number`                                                  | 生存时间：如果消息尚未送达，可为重新投递而保留的秒数。默认为 `undefined`，以使用各提供商的相应默认值（Android/FCM 和 iOS/APNs 均为 1 个月）。                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `expiration`        | Android 和 iOS  | `number`                                                  | 指定消息过期时间的 Unix 纪元时间戳。效果与 `ttl` 相同（`ttl` 优先于 `expiration`）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `priority`          | Android 和 iOS  | `'default' \| 'normal' \| 'high'`                         | 消息的投递优先级。指定 `default` 或省略此字段，以使用各平台的默认优先级（Android 上为“普通”，iOS 上为“高”）。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `subtitle`          | 仅限 iOS        | `string`                                                  | 要在通知中显示的副标题，位于标题下方。映射到 [`aps.alert.subtitle`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Payload-key-reference)。                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `sound`             | 仅限 iOS        | `string \| null`                                          | 接收者收到此通知时播放声音。指定 `default` 以播放设备的默认通知声音，或省略此字段以不播放声音。自定义声音需要通过配置插件进行[配置](/versions/latest/sdk/notifications/#configurable-properties)，然后在指定时包含文件扩展名。例如：`bells_sound.wav`。                                                                                                                                                                                                                                                                                                 |
| `badge`             | 仅限 iOS        | `number`                                                  | 要在应用图标徽章上显示的数字。指定零以清除徽章。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `interruptionLevel` | 仅限 iOS        | `'active' \| 'critical' \| 'passive' \| 'time-sensitive'` | 通知的重要性和投递时间。字符串值对应于 [`UNNotificationInterruptionLevel`](https://developer.apple.com/documentation/usernotifications/unnotificationinterruptionlevel) 枚举中的各个情况。                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `channelId`         | 仅限 Android    | `string`                                                  | 用于显示此通知的通知渠道 ID。如果指定了 ID，但设备上不存在对应的渠道（且该渠道尚未由你的应用创建），通知将不会显示给用户。                                                                                                                                                                                                                                                                                                                                                                                                              |
| `icon`              | 仅限 Android    | `string`                                                  | 通知的图标。Android 可绘制资源的名称（例如：`myicon`）。默认使用[配置插件](/versions/latest/sdk/notifications/#configurable-properties)中指定的图标。                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `richContent`       | Android 和 iOS  | `Object`                                                  | 目前支持设置通知图片。提供一个包含 `image` 键的对象，其值类型为 `string`，表示图片 URL。Android 开箱即用即可显示图片。在 iOS 上，需要向应用添加通知服务扩展目标。请参阅[此示例](https://github.com/expo/expo/pull/36202)了解如何执行此操作。                                                                                                                                                                                                                                                                                                                           |
| `categoryId`        | Android 和 iOS  | `string`                                                  | 此通知关联的通知类别 ID。[在此处详细了解通知类别](/versions/latest/sdk/notifications/#manage-notification-categories-interactive-notifications)。                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `collapseId`        | Android 和 iOS  | `string`                                                  | 用于折叠通知的标识符。在 Android 上，这只会合并传输中的消息（如果设备处于离线状态，则只会投递具有给定 `collapseId` 的最新消息），并映射到 FCM 的 [`collapse_key`](https://firebase.google.com/docs/cloud-messaging/customize-messages/collapsible-message-types)。若要替换 Android 上已显示的通知，请使用 `tag`。在 iOS 上，它既会合并传输中的消息，也会替换设备上已显示的通知，并映射到 [`apns-collapse-id`](https://developer.apple.com/documentation/usernotifications/generating-a-remote-notification#Send-a-POST-request-to-APNs)。 |
| `tag`               | 仅限 Android    | `string`                                                  | 用于替换设备上已显示通知的标识符。如果设备已显示具有相同 `tag` 的通知，新通知将替换它。这与 `collapseId` 不同：`collapseId` 会合并_传输中的_消息，而 `tag` 会替换_已显示的_通知。映射到 FCM 的 [`notification.tag`](https://firebase.google.com/docs/reference/fcm/rest/v1/projects.messages#AndroidNotification) 字段。                                                                                                                                                                                                            |
| `mutableContent`    | 仅限 iOS        | `boolean`                                                 | 指定此通知是否可以[被客户端应用拦截](https://developer.apple.com/documentation/usernotifications/modifying-content-in-newly-delivered-notifications?language=objc)。默认为 `false`。                                                                                                                                                                                                                                                                                                                                                                                                                                            |

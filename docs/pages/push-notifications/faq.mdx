...
If you are not using [Expo Push Notification Service](/push-notifications/sending-notifications), but instead want to communicate directly with Google and Apple, see [Send Notifications with FCM and APNs](/push-notifications/sending-notifications-custom).

### Notification icons on Android are gray or white squares

This indicates that there is an issue with the image asset you provided. The image should be pure white with a transparent background (this is a Google requirement and is enforced by Google, not Expo). For more information, see [this article](https://clevertap.com/blog/fixing-notification-icon-for-android-lollipop-and-above/).
